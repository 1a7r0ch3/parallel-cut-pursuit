...
import wrapper_cp_pfdr_d1_ql1b.cp_pfdr_d1_ql1b_py
imp.reload(wrapper_cp_pfdr_d1_ql1b.cp_pfdr_d1_ql1b_py)
from wrapper_cp_pfdr_d1_ql1b.cp_pfdr_d1_ql1b_py import cp_pfdr_d1_ql1b_py 
...
collec = ax.plot_trisurf(vertices[:,0],vertices[:,1], vertices[:,2], triangles=faces, cmap = cmap)
...
Comp, rX, it, Obj, Time, Dif = cp_pfdr_d1_ql1b_py(y, Phi, first_edge, adj_vertices, d1_weights, Yl1, l1_weights, Lbnd, Ubnd, CP_difTol,CP_itMax, PFDR_rho, PFDR_condMin, PFDR_difRcd, PFDR_difTol, PFDR_itMax, PFDR_verbose, out_Obj=True, out_Dif=True, out_Time=True)
...
print('Dice score: raw %.2f; approx (discard less significant with 2-means) %.2f\n\n', DS, DSa)
